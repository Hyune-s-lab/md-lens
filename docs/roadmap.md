...
- Capture JCEF console messages and page load errors, and increase the bootstrap timeout to 30s
- Retry stalled page loads and use an EDT-independent timer to survive concurrent browser initialization
